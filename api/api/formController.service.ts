...
import { DefaultFormDto } from '../model/defaultFormDto';
...
export class FormControllerService {
     ...
     */
    public addFormularDefault(body: DefaultFormDto, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addFormularDefault(body: DefaultFormDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addFormularDefault(body: DefaultFormDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addFormularDefault(body: DefaultFormDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling addFormularDefault.');
        }
    ...
    public addFormularPrivate(body: PatientDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/api/form/private`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
