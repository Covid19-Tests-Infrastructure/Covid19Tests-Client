...
export class AuthControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public isTokenValid(observe?: 'body', reportProgress?: boolean): Observable<UserDto>;
    public isTokenValid(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserDto>>;
    public isTokenValid(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserDto>>;
    public isTokenValid(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<UserDto>('get',`${this.basePath}/api/authenticate/check`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
